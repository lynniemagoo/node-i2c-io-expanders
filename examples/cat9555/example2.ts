...
// Define pin 8 as inverted output with initally false
cat.outputPin(8, true, false)

// Then define pin 9 as inverted output with initally true
  .then(() => {
    return cat.outputPin(9, true, true);
  })
  ...
  .then(() => {
    console.log('turn pin 8 on');
    return cat.setPin(8, true);
  })
  ...
  .then(() => {
    console.log('turn pin 8 off');
    return cat.setPin(8, false);
  });
