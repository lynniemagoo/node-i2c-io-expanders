...
// Import the MCP23017A and MCP23017B class
//import { MCP23017A, MCP23017B } from 'i2c-io-expanders';
import { MCP23017A, MCP23017B } from '../../';
...
const chipPortA: MCP23017A = new MCP23017A(i2cBus, addr);
const chipPortB: MCP23017B = new MCP23017B(i2cBus, addr);
...
const example = async () : Promise<void> => {
  ...
  chipPortA.on('input', (data: MCP23017A.InputData) => {
  ...
  chipPortA.on('interrupt', function (_processed: boolean) {
